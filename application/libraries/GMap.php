...
class Gmap {
     ...
     * @var string
     */
    var $browser_alert = 'Lo sentimos, Google Maps no es compatible con su explorador.';
     ...
     * @var string
     */
    var $js_alert = '<b>Javascript debe estar habilitado para ver Google Maps.</b>';
