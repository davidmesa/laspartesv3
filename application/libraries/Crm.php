...
class Crm {
     ...
     */
    public function dar_id_usuario_pipeline_REST($id_pipeline)  {
        if(ENVIRONMENT == 'production'):
            $user_id = $this->session_id;
            
            //Obtención del nombre del usuario asociado al pipeline
            ...
            $id = $this->call('get_entry_list', $get_entry_list_parameters, $this->url)->relationship_list[0]->link_list[0]->records[0]->link_value->id->value;
            return $id;
        endif;
    }

    function prueba($id_usuario) {
            $user_id = $this->session_id;
            ...
            $get_entry_list_parameters = array(
                ...
                'session'=>$user_id,
                 ...
                 'related_module_link_name_to_fields_array' => array(
                    array(
                         'name' => 've111_marcalinea_ve111_vehiculos',
                         'value' => array(
                             'id',
                             'name',
                             'marca',
            ...
            $get_relationships_result = $this->call('get_relationships', $get_entry_list_parameters, $this->url);
