...
<script>
    ...
    $(document).ready(function(){
        ...
        $('.autopart-h4-categoria-titulo').live('click', function(){
            ...
            //evento de google
            _gaq.push(['_trackEvent', 'Promocion', 'categoria', busqueda]);
        ...
        $('.usuario-div-oferta-tarjetas').click(function(){
            $('.usuario-form-oferta-comprar').submit();
//                alert('click');
        });
    ...
    var url = window.location.pathname;
    var urlArray =  url.split("/");
    var idOferta = urlArray[2].split("-");
    _gaq.push(['_trackEvent', 'Promocion', 'Clic', urlArray[2], idOferta[0]]);
</script>
