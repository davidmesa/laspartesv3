...
<html xmlns="http://www.w3.org/1999/xhtml"  xmlns:og="http://ogp.me/ns" xmlns:fb="http://www.facebook.com/2008/fbml">
    <head <?php if ($headPrefix != "") echo  $headPrefix;?>>
        ...
        <title><?php echo $titulo; ?></title>
            ...
            <?php if ($metaTipo != "" || sizeof(metaTipo) > 1) ?>
                <meta property="og:type" content="<?php echo $metaTipo; ?>"/>
                
            <?php if ($metaExtras != "" || sizeof($metaExtras) > 1) echo $metaExtras;?>
            ...
            <meta property="fb:app_id"  content="382292381857467" /> 
        ...
        <body>
            ...
            function publicar_actividad_fb(){ 
            FB.getLoginStatus(function(response) {
                if (response.status === 'connected') { 
                    FB.api(
                    'me/laspartes:ask', 'post',
                    {repair_shops: "<?php echo base_url();?>preguntas"}
                );
                }
            });
            }
