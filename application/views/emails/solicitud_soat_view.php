                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="500" align="right">
                                        ...
                                        <span style="color:#c9c9c9; padding-right:20px;  font-size:23px;">"Solicitud de SOAT"</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                <tr>
                                    <td valign="top" align="left" style="padding-left:30px;">
                                        <span style="color:black; font-weight:bold; font-size:20px;"><?php echo $usuario->nombres; ?></span><br/>
                                        <span style="color:black; font-size:14px;"><strong>Correo electrónico:</strong> <?php echo $usuario->email; ?></span><br/>
                                        <span style="color:black; font-size:14px;"><strong>Teléfono:</strong> <?php echo $telefono; ?></span><br/>
                                        <span style="color:black;  font-size:14px;"><strong>Vehículo:</strong> <?php echo $vehiculo->marca . ' ' . $vehiculo->linea . ' modelo: ' . $vehiculo->modelo . ' con: ' . $vehiculo->kilometraje . 'Kms.'; ?></span><br/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                ...
                                <tr>
                                    <td align="left" style="padding-left: 30px; padding-right:30px;">
                                        <ul style="padding-left:25px; color:#404040; font-size:13px;">
                                            <li>
                                                <span style="font-weight: bold; font-size: 18px;">Gracias por enviar tu solicitud, en breve uno de nuestros asesores se comunicará contigo.</span>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
