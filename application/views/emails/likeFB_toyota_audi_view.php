...
<title>Mantemiento de bomper a bomper laspartes.com</title>
</head>
        	...
        	<td align="center">
            	<table width="660" border="0" cellpadding="0" cellspacing="0"border="0" bgcolor="#FFFFFF">
                	<tbody>
                    	<tr>
                        	<td width="160"> 
                            	<img src="<?php echo base_url();?>resources/images/correos/pregunta/pregunta-mujer.png" alt="Entradas de cortesía al salón del automóvil" />
                            </td>
                            <td width="500" align="right">
                                ...
                                <span style="color:#c9c9c9; padding-right:20px;  font-size:26px;">¿Qué te gustaría de navidad?</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
                	...
                	<tbody>
                    	<tr>
                        	<td valign="top" align="left" style="padding-left:30px;">
                            	<span style="color:black; font-weight:bold; font-size:20px;">Gana un lavado y polichado para tu carro cuentandonos qué te gustaría de navidad<span><br/><br/> 
                            </td>
                        </tr>
                    </tbody>
                </table>
                	...
                	<tbody>
                    	<tr>
                        	<td align="left" style="padding-left: 30px; padding-right:30px;">
                                <ul style="padding-left:25px; color:#404040; font-size:13px;">
                                	<li>
                                            <span style="font-weight: bold; font-size: 18px;">¿Cómo ganar? Es muy f&aacute;cil...</span><br/>
                                        <span style="font-size:13px;">Ingresa a nuestra página en facebook <a href="http://www.facebook.com/laspartes">www.facebook.com/laspartes</a>. Dale like. Cuéntanos qué accesorios te gustaría que te regalaran en navidad para tu carro. Rifaremos un embellecimiento completo que incluye lavado y polichado entre las personas que respondan.</span><br/>
                                    </li>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                        	<td align="right" style="padding-right:40px; padding-top:30px;">
                            	<a href="http://www.facebook.com/laspartes">
                                    <img style="border:none;" src="<?php echo base_url();?>resources/images/correos/navidadFB/participa-aqui.png" alt="que quieres de navidad" />
                               	</a>     
                            </td>
                        </tr>
                    </tbody>
