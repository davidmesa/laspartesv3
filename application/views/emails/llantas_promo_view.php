                	...
                	<tbody>
                    	<tr>
                            ...
                            <td width="500" align="right">
                                ...
                                <span style="color:#c9c9c9; padding-right:20px;  font-size:23px;">En navidad dale un regalo a tu vehículo</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
                	...
                	<tbody>
                    	<tr>
                        	<td align="left" style="padding-left: 30px; padding-right:30px;">
                                <ul style="padding-left:25px; color:#404040; font-size:13px;">
                                	<li>
                                            <span style=" font-size: 18px;"><strong>Alineación y balanceo gratis</strong> por la compra de llantas a través de laspartes.com. ¡Qué esperas!</span>
                                    </li>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                        	<td align="right" style="padding-right:40px; padding-top:30px;">
                            	<a href="http://www.laspartes.com/autopartes/buscar/categoria/Llantas">
                                    <img style="border:none;" src="<?php echo base_url();?>resources/images/correos/navidadFB/compra-aqui.png" alt="compra aqui" />
                               	</a>     
                            </td>
                        </tr>
                    </tbody>
