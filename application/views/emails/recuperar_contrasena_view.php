                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="500" align="right">
                                        ...
                                        <span style="color:#c9c9c9; padding-right:20px;  font-size:20px;">"Recuperar contraseña"</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                ...
                                <tr>
                                    <td align="left" style="padding-left: 30px; padding-right:30px;">
                                        <ul style="padding-left:25px; color:#404040; font-size:13px;">
                                            <li>
                                                <span style="font-size: 16px;">Para recuperar tu contrase&ntilde;a, haz click <a style="text-decoration: none; color: red;" href="<?php echo $link_seguro;?>">aqu&iacute;</a>.<br />
                                                    <br />
                                                    En caso de que no veas este link, copia y pega lo siguiente en tu explorador de internet: <br /><?php echo $link_seguro;?>
                                                    <br />
                                                    <br />
                                                    Cordialmente,<br />
                                                    -------------------------------------------------------<br />
                                                    Servicio al cliente<br />
                                                    <a style="text-decoration: none; color: red;" href="<?php echo base_url();?>">Laspartes.com.co</a> - Todo para tu vehículo</span>
                                            </li> 
                                        </ul>
                                    </td>
                                </tr>
