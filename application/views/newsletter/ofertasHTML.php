            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr width ="600px">
                    ...
                    <td valign="top" height="1200px" width="330px" >
                        ...
                        <div style="padding-left: 5px; padding-right: 5px; font-family: HELVETICA; font-size: 12px; ">Estas son las ofertas vigentes para le fecha</div>
                       <div style="clear: left;"></div>
                       
                        <?php foreach ($ofertas as $oferta):?>
                            <div style="text-align: justify;  padding: 10px 10px 10px 5px;">
                                <div style="text-transform: uppercase; font-family: HELVETICA; font-weight: bolder;font-size: 15px; color: #010101" ><?php echo $oferta->titulo; ?></div>
                                <p style=" font-family: sans-serif; font-size: 12px; color: #6f6b6b;" id="content_noticia">
                                    Precio: $<?php echo number_format($oferta->precio);?>
                                </p>  
                                    <?php echo $oferta->descripcion;?>

                            </div>
                           
                            <div style="text-transform: lowercase; font-family: sans-serif; text-align: right; padding-right: 10px; font-weight: bold;font-size: 12px;  font-style: italic;"><a style="text-decoration: none; color: red;" href="<?php echo base_url() . 'usuario/registrate'; ?>">Comprar>></a></div>
                            <div style="color: lightslategray; text-transform: lowercase; font-family: sans-serif; padding-top: 4px; padding-left: 3px; font-size: 8px; ">*ingresando con tu usuario y contraseña, en la sección de ofertas, podrás visualizar esta oferta.</div>
