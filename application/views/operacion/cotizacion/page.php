...
<body>
  ...
  <div class="form-group">
    <!--<div class="bs-callout bs-callout-info"><button type="button" class="close" data-dismiss="alert">&times;</button>
      <h4>Nota</h4>
      <p>Recuerda que no se pueden agregar items con el mismo nombre, corrige los duplicados existentes.<br/></p>
    ...
    <div id="example1" style="position: relative;" class="handsontable"></div>
  </div>
  <!-- <div class="form-group">
    <p>
