...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Autopartes :: Ver o Actualizar Categoría</title>
    ...
    <body>
        ...
        <div id="main_content_wrap" class="container_12">
            <div class="container_12">
                ...
                <?php echo form_open('admin/autoparte/actualizar_autoparte_categoria'); ?>
                    <input type="hidden" name="id_autoparte_categoria" value="<?php echo $autoparte_categoria->id_autoparte_categoria; ?>" />
                    <p>
                      <label>Nombre</label><br />
                      <input name="nombre" type="text" class="text medium" value="<?php echo $autoparte_categoria->nombre; ?>" />
                    </p>
                    <p>
