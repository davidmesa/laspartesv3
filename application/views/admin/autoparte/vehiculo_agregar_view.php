...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Autopartes :: Agregar Vehículo</title>
    ...
    <body>
        ...
        <div id="main_content_wrap" class="container_12">
            <div class="container_12">
                ...
                <?php echo form_open_multipart('admin/autoparte/agregar_vehiculo'); ?>
                    <p>
                      <label>Marca</label><br />
                      <input name="marca" type="text" class="text medium" value="<?php echo set_value('marca'); ?>" />
                    </p>
                    <p>
                      <label>Línea</label><br />
                      <input name="linea" type="text" class="text medium" value="<?php echo set_value('linea'); ?>" />
                    </p>
                    <p>
                        <input type="submit" class="submit" value="Agregar Vehículo" />
                    </p>
                <?php echo form_close(); ?>
            </div>
