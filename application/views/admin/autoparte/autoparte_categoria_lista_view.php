...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Autopartes :: Lista de Categorías de Autopartes</title>
...
<?php } ?>
                ...
                <h2>Lista de Categorías de Autopartes</h2>
                <a title="Agregar autoparte categoría" href="<?php echo base_url(); ?>admin/autoparte/formulario_autoparte_categoria"><img src="<?php echo base_url(); ?>resources/admin/images/add.png" alt="Agregar una categoría" /> Agregar una categoría de autoparte</a>
                ...
                <table width="100%">
                    ...
                    <tbody>
                        <?php if (sizeof($autopartes_categorias) != 0) {
                            foreach ($autopartes_categorias as $autoparte_categoria) {
                                ?>
                                <tr>
                                    <td><a title="Ver autoparte categoría" href="<?php echo base_url(); ?>admin/autoparte/ver_autoparte_categoria/<?php echo $autoparte_categoria->id_autoparte_categoria; ?>"><?php echo $autoparte_categoria->id_autoparte_categoria; ?></a></td>
                                    <td><?php echo $autoparte_categoria->nombre; ?></td>
                                    <td><a title="Ver autoparte categoría" href="<?php echo base_url(); ?>admin/autoparte/ver_autoparte_categoria/<?php echo $autoparte_categoria->id_autoparte_categoria; ?>"><img src="<?php echo base_url(); ?>resources/admin/images/pencil.png" alt="Ver o Actualizar Categoría" /></a> <a title="Eliminar autoparte categoría" href="<?php echo base_url(); ?>admin/autoparte/eliminar_autoparte_categoria/<?php echo $autoparte_categoria->id_autoparte_categoria; ?>" onclick="return confirm('¿Está seguro de eliminar esta categoría? Recuerde que no puede existir autopartes asociadas a esta categoría para poderla eliminar.');"><img src="<?php echo base_url(); ?>resources/admin/images/cancel.png" alt="Eliminar Categoría" /></a></td>
                                </tr>
    <?php }
}
?>
