...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Autopartes :: Lista de Marcas de Autopartes</title>
...
<?php } ?>
                ...
                <h2>Lista de Marcas de Autopartes</h2>
                <a title="Agregar marca de autoparte" href="<?php echo base_url(); ?>admin/autoparte/formulario_autoparte_marca"><img src="<?php echo base_url(); ?>resources/admin/images/add.png" alt="Agregar una marca" /> Agregar una marca de autoparte</a>
                ...
                <table width="100%">
                    ...
                    <tbody>
                        <?php if (sizeof($autopartes_marcas) != 0) {
                            foreach ($autopartes_marcas as $autoparte_marca) {
                                ?>
                                <tr>
                                    <td><a title="Ver marca de autoparte" href="<?php echo base_url(); ?>admin/autoparte/ver_autoparte_marca/<?php echo $autoparte_marca->id_autoparte_marca; ?>"><?php echo $autoparte_marca->id_autoparte_marca; ?></a></td>
                                    <td><?php echo $autoparte_marca->nombre; ?></td>
                                    <td><a title="Ver marca de autoparte" href="<?php echo base_url(); ?>admin/autoparte/ver_autoparte_marca/<?php echo $autoparte_marca->id_autoparte_marca; ?>"><img src="<?php echo base_url(); ?>resources/admin/images/pencil.png" alt="Ver o Actualizar Marca" /></a> <a title="Eliminar marca de autoparte" href="<?php echo base_url(); ?>admin/autoparte/eliminar_autoparte_marca/<?php echo $autoparte_marca->id_autoparte_marca; ?>" onclick="return confirm('¿Está seguro de eliminar esta marca? Recuerde que no puede existir autopartes asociadas a esta marca para poderla eliminar.');"><img src="<?php echo base_url(); ?>resources/admin/images/cancel.png" alt="Eliminar Marca" /></a></td>
                                </tr>
    <?php }
}
?>
