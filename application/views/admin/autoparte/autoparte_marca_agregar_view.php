...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Autopartes :: Agregar Marca</title>
    ...
    <body>
        ...
        <div id="main_content_wrap" class="container_12">
            <div class="container_12">
                ...
                <?php echo form_open_multipart('admin/autoparte/agregar_autoparte_marca'); ?>
                    <p>
                      <label>Nombre</label><br />
                      <input name="nombre" type="text" class="text medium" value="<?php echo set_value('nombre'); ?>" />
                    </p>
                    <p>
          		<input type="submit" class="submit" value="Agregar Marca" />
                    </p>
                <?php echo form_close(); ?>
            </div>
