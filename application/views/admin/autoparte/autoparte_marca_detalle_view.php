...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Autopartes :: Ver o Actualizar Marca</title>
    ...
    <body>
        ...
        <div id="main_content_wrap" class="container_12">
            <div class="container_12">
                <h2>Ver o Actualizar Marca</h2>
                <?php echo validation_errors('<div class="notification failure canhide"><p>', '</p></div>'); ?>
                <?php echo form_open('admin/autoparte/actualizar_autoparte_marca'); ?>
                    <input type="hidden" name="id_autoparte_marca" value="<?php echo $autoparte_marca->id_autoparte_marca; ?>" />
                    <p>
                      <label>Nombre</label><br />
                      <input name="nombre" type="text" class="text medium" value="<?php echo $autoparte_marca->nombre; ?>" />
                    </p>
                    <p>
          		<input type="submit" class="submit" value="Actualizar Marca" />
                    </p>
                <?php echo form_close(); ?>
            </div>
