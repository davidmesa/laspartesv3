...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Aprende :: Lista de Noticias</title>
...
<?php } ?>
                ...
                <a title="Agregar noticia" href="<?php echo base_url(); ?>admin/aprende/formulario_agregar_noticia"><img src="<?php echo base_url(); ?>resources/admin/images/add.png" alt="Agregar una noticia" /> Agregar una noticia</a>
                    ...
                    <tbody>
                        <?php if (sizeof($noticias) != 0) {
                            foreach ($noticias as $noticia) {
                                ?>
                                <tr>
                                    <td><a title="Ver noticia" href="<?php echo base_url(); ?>admin/aprende/ver_noticia/<?php echo $noticia->id_noticia; ?>"><?php echo $noticia->id_noticia; ?></a></td>
                                    <td><?php echo $noticia->titulo; ?></td>
                                    <td><?php echo $noticia->fecha; ?></td>
                                    <td><?php if ($noticia->estado == 'Activo') { ?><img title="Activo" src="<?php echo base_url(); ?>resources/admin/images/bullet_green.png" alt="Activo" /><?php } else { ?><img title="Inactivo" src="<?php echo base_url(); ?>resources/admin/images/bullet_red.png" alt="No Activo" /><?php } ?></td>
                                    <td><a title="Ver noticia" href="<?php echo base_url(); ?>admin/aprende/ver_noticia/<?php echo $noticia->id_noticia; ?>"><img src="<?php echo base_url(); ?>resources/admin/images/pencil.png" alt="Ver o Actualizar Noticia" /></a></td>
                                </tr>
    <?php }
}
?>
