...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Aprende :: Lista de Tips</title>
...
<?php } ?>
                ...
                <h2>Lista de Tips y Consejos</h2>
                <a title="Agregar tip" href="<?php echo base_url(); ?>admin/aprende/formulario_agregar_tip"><img src="<?php echo base_url(); ?>resources/admin/images/add.png" alt="Agregar un tip o consejo" /> Agregar un tip o consejo</a>

                <table width="100%">
                    <thead>
                        <tr>
                            <th data-placeholder="ID">ID</th>
                            <th data-placeholder="Título">Título</th>
                            <th data-placeholder="Fecha">Fecha</th>
                    ...
                    <tbody>
                        <?php if (sizeof($tips) != 0) {
                            foreach ($tips as $tip) {
                                ?>
                                <tr>
                                    <td><a title="Ver tip" href="<?php echo base_url(); ?>admin/aprende/ver_tip/<?php echo $tip->id_tip; ?>"><?php echo $tip->id_tip; ?></a></td>
                                    <td><?php echo $tip->titulo; ?></td>
                                    <td><?php echo $tip->fecha; ?></td>
                                    <td><?php if ($tip->estado == 'Activo') { ?><img title="Activo"src="<?php echo base_url(); ?>resources/admin/images/bullet_green.png" alt="Activo" /><?php } else { ?><img title="Inactivo" src="<?php echo base_url(); ?>resources/admin/images/bullet_red.png" alt="No Activo" /><?php } ?></td>
                                    <td><a title="Ver tip" href="<?php echo base_url(); ?>admin/aprende/ver_tip/<?php echo $tip->id_tip; ?>"><img src="<?php echo base_url(); ?>resources/admin/images/pencil.png" alt="Ver o Actualizar Tip" /></a></td>
                                </tr>
    <?php }
}
?>
