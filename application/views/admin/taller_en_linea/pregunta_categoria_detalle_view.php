...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Taller en Línea :: Ver o Actualizar Categoría</title>
    ...
    <body>
        ...
        <div id="main_content_wrap" class="container_12">
            <div class="container_12">
                <h2>Ver o Actualizar Categoría</h2>
                <?php echo validation_errors('<div class="notification failure canhide"><p>', '</p></div>'); ?>
                <?php echo form_open('admin/taller_en_linea/actualizar_pregunta_categoria'); ?>
                    <input type="hidden" name="id_pregunta_categoria" value="<?php echo $pregunta_categoria->id_pregunta_categoria; ?>" />
                    <p>
                      <label>Nombre</label><br />
                      <input name="nombre" type="text" class="text medium" value="<?php echo $pregunta_categoria->nombre; ?>" />
                    </p>
                    <p>
          		<input type="submit" class="submit" value="Actualizar Categoría" />
                    </p>
                <?php echo form_close(); ?>
            </div>
