...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Taller en Línea :: Preguntas</title>
                ...
                <table width="100%"  id="backend_tabla" class="tablesorter">
                    <thead>
                        <tr>
                            ...
                            <th data-placeholder="Pregunta" class="tablesorter-header">Pregunta</th>
                            <th data-placeholder="Usuario" class="tablesorter-header">Usuario</th>
                            <th data-placeholder="" class="filter-false">Respuestas</th>
                    ...
                    <tbody>
                        ...
                        if (sizeof($preguntas) != 0) {
                            foreach ($preguntas as $pregunta) {
                                ?>
                                <tr>
                                    <td><a title="Ver pregunta" href="<?php echo base_url(); ?>admin/taller_en_linea/ver_pregunta/<?php echo $pregunta->id_pregunta; ?>"><?php echo $pregunta->id_pregunta; ?></a></td>
                                    <td><b><?php echo $pregunta->titulo_pregunta; ?></b><br /><?php echo $pregunta->cuerpo_pregunta; ?></td>
                                    <td><?php echo $pregunta->usuario; ?></td>
                                    <td><?php echo $pregunta->numero_respuestas; ?></td>
                                    <td><?php if ($pregunta->estado == 'Activo') { ?><img title="Activo" src="<?php echo base_url(); ?>resources/admin/images/bullet_green.png" alt="Activo" /><?php } else { ?><img  title="Inactivo" src="<?php echo base_url(); ?>resources/admin/images/bullet_red.png" alt="No Activo" /><?php } ?></td>
                                    <td><a title="Ver pregunta" href="<?php echo base_url(); ?>admin/taller_en_linea/ver_pregunta/<?php echo $pregunta->id_pregunta; ?>"><img src="<?php echo base_url(); ?>resources/admin/images/pencil.png" alt="Ver o Actualizar Pregunta" /></a></td>
                                </tr>
                            <?php
                            }
                        }
