...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script>
            $(function(){
                var nombreTalleres = <?php echo json_encode($tituloOferta); ?>; 
                ...
                $("#backend_input_buscar").autocomplete({
                    ...
                    select: function(e, ui) {
                        ...
                        $(document).scrollTop( $("#oferta_"+id_taller_actual).offset().top );  
                    }
                });
                
                
                $("#backend_tabla").tablesorter({
                    theme: 'blue',
    ...
    <body>
        ...
        <div id="main_content_wrap" class="container_12">
            <div class="container_12">
                ...
                <a style="float: left;" title="Agregar una oferta" href="<?php echo base_url(); ?>admin/establecimiento/formulario_oferta/<?php echo $id_establecimineto; ?>"><img src="<?php echo base_url(); ?>resources/admin/images/add.png" alt="Agregar una oferta" /> Agregar una oferta</a>
                <form action="javascript:void(0);"><div class="backend_buscar"><span>Buscar: </span><input title="Busca un establecimiento" type="text" name="backend_input_buscar" id="backend_input_buscar" class="backend_input_buscar text medium"/></div></form>
                <div class="clear"></div>
                <table width="100%" id="backend_tabla" class="tablesorter">
                    <thead> 
                        <tr class="tablesorter-headerRow">
                            <th data-placeholder="" class="filter-false" width="25">ID</th>
                            <th data-placeholder="Titulo" class="tablesorter-header" width="200">Titulo</th>
                            <th data-placeholder="Precio"  class="tablesorter-header"  width="60">Precio</th>
                            <th data-placeholder="Condiciones" width="170"  class="tablesorter-header">Condiciones</th>
                            <th data-placeholder="Incluye"  class="tablesorter-header">Incluye</th>
                            <th data-placeholder=""  class="tablesorter-header filter-false">Acciones</th>
                        </tr>
                    </thead> 
                    <tbody> 
                        <?php
                        if (sizeof($establecimiento_ofertas) != 0) {
                            foreach ($establecimiento_ofertas as $oferta):
                                ?>
                                <tr id="oferta_<?php echo $oferta->id_oferta; ?>">
                                    <td><a title="Ver oferta" href="<?php echo base_url(); ?>admin/establecimiento/ver_oferta/<?php echo $oferta->id_oferta; ?>/<?php echo $id_establecimineto; ?>"><?php echo $oferta->id_oferta; ?></a></td>
                                    <td><?php echo $oferta->titulo; ?></td>
                                    <td><?php echo $oferta->precio; ?></td>
                                    <td><?php echo $oferta->condiciones; ?></td>
                                    <td><?php echo $oferta->incluye; ?></td> 
                                    <td><a  title="Ver oferta" href="<?php echo base_url(); ?>admin/establecimiento/ver_oferta/<?php echo $oferta->id_oferta; ?>/<?php echo $id_establecimineto; ?>"><img src="<?php echo base_url(); ?>resources/admin/images/pencil.png" alt="Ver o Actualizar Oferta" /></a>  <a title="Eliminar oferta" href="<?php echo base_url(); ?>admin/establecimiento/eliminar_oferta/<?php echo $id_establecimineto; ?>/<?php echo $oferta->id_oferta; ?>" onclick="return confirm('¿Está seguro de eliminar esta oferta?');"><img src="<?php echo base_url(); ?>resources/admin/images/cancel.png" alt="Eliminar Oferta" /></a></td>
                                </tr>
                                <?php
                            endforeach;
                        }
