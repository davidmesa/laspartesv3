...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Establecimientos :: Agregar Servicio</title>
    ...
    <body>
        ...
        <div id="main_content_wrap" class="container_12">
            <div class="container_12">
                ...
                <?php echo form_open('admin/establecimiento/agregar_servicio'); ?>
                    <p>
                      <label>Nombre</label><br />
                      <input name="nombre" type="text" class="text medium" value="<?php echo set_value('nombre'); ?>" />
                    </p>
                    <p>
          		<input type="submit" class="submit" value="Agregar Servicio" />
                    </p>
                <?php echo form_close(); ?>
            </div>
