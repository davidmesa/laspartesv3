...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Establecimientos :: Lista de Servicios</title>
    ...
    <body>
        ...
        <div id="main_content_wrap" class="container_12">
            <div class="container_12">
                ...
                <a href="<?php echo base_url(); ?>admin/establecimiento/formulario_servicio"><img src="<?php echo base_url(); ?>resources/admin/images/add.png" alt="Agregar un servicio" /> Agregar un servicio</a>

                <table width="100%">
                    <thead>
                    <tr>
                        <th class="tablesorter-header" >ID</th>
                    ...
                    <tr>
                        <td><a href="<?php echo base_url(); ?>admin/establecimiento/ver_servicio/<?php echo $servicio->id_servicio; ?>"><?php echo $servicio->id_servicio; ?></a></td>
                        <td><?php echo $servicio->nombre; ?></td>
                        <td><a href="<?php echo base_url(); ?>admin/establecimiento/ver_servicio/<?php echo $servicio->id_servicio; ?>"><img src="<?php echo base_url(); ?>resources/admin/images/pencil.png" alt="Ver o Actualizar Servicio" /></a>  <a href="<?php echo base_url(); ?>admin/establecimiento/eliminar_servicio/<?php echo $servicio->id_servicio; ?>" onclick="return confirm('¿Está seguro de eliminar este servicio?');"><img src="<?php echo base_url(); ?>resources/admin/images/cancel.png" alt="Eliminar Servicio" /></a></td>
                    </tr>
                    <?php }
                    }?>
                    </tbody>
