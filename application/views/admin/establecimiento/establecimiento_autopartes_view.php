...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>resources/admin/css/jqueryui.css" />
            ...
            $(document).ready(function() {
                ...
                $("input[name^=precio_]").change( function() {
                    ...
                    if($("#checkbox_"+id_autoparte).attr('checked'))
                    {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url(); ?>admin/establecimiento/ajax_actualizar_precio_establecimiento_autoparte",
                            context: this,
                            data: {
                ...
                $("input[id^=checkbox_]").change( function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>admin/establecimiento/ajax_actualizar_establecimiento_autoparte",
                        context: this,
                        data: {
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($autoparte->referencia != "") echo "<b>Ref: </b>".$autoparte->referencia."<br/>"; ?>
                                    <strong>Marca:</strong> <?php echo $autoparte->marca; ?><br/>
                                    <?php if($autoparte->origen != "") echo "<b>Origen: </b>".$autoparte->origen."<br/>"; ?>
                                    ...
                                    <br/>
                                        ...
                                        <input id="btn_eliminar_<?php echo $autoparte->id_autoparte; ?>" class="submit" type="submit" value="Eliminar" />
                                        <input id="btn_editar_<?php echo $autoparte->id_autoparte; ?>" class="submit" type="submit" value="Editar" />
