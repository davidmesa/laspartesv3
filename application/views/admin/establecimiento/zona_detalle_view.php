...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Establecimientos :: Ver o Actualizar Zona</title>
    ...
    <body>
        ...
        <div id="main_content_wrap" class="container_12">
            <div class="container_12">
                ...
                <?php echo form_open('admin/establecimiento/actualizar_zona'); ?>
                    <input type="hidden" name="id_zona" value="<?php echo $zona->id_zona; ?>" />
                    <p>
                      <label>Ciudad</label><br />
                      <input name="ciudad" type="text" class="text medium" value="<?php echo $zona->ciudad; ?>" />
                    </p>
                    <p>
                      <label>Nombre</label><br />
                      <input name="nombre" type="text" class="text medium" value="<?php echo $zona->nombre; ?>" />
                    </p>
                    <p>
          		<input type="submit" class="submit" value="Actualizar Zona" />
                    </p>
                <?php echo form_close(); ?>
            </div>
