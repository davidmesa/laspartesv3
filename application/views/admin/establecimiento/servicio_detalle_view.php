...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Las Partes Admin :: Establecimientos :: Ver o Actualizar Servicio</title>
    ...
    <body>
        ...
        <div id="main_content_wrap" class="container_12">
            <div class="container_12">
                <h2>Ver o Actualizar Servicio</h2>
                ...
                <?php echo form_open('admin/establecimiento/actualizar_servicio'); ?>
                    <input type="hidden" name="id_servicio" value="<?php echo $servicio->id_servicio; ?>" />
                    <p>
                      <label>Nombre</label><br />
                      <input name="nombre" type="text" class="text medium" value="<?php echo $servicio->nombre; ?>" />
                    </p>
                    <p>
          		<input type="submit" class="submit" value="Actualizar Servicio" />
                    </p>
                <?php echo form_close(); ?>
            </div>
