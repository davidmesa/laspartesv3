            ...
            <tr>
                ...
                <td colspan="2" valign="top" class="box_fondo">
                    <table width="930" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td width="185" height="22" class="box_fondo box_titulo"><h1>HÁGALO USTED MISMO</h1></td>
                            <td width="717" class="box_fondo_contenido">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="box_fondo_contenido">
                                <table width="901" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="20">&nbsp;</td>
                                        <td  class="tallerenlinea_texto_pregunta" align="left" style="padding-top:10px;"><strong><?php echo $tutorial->titulo; ?></strong></td>
                                        <td align="right">
                                            <table width="200">
                                                <tr>
                                                    ...
                                                    <td align="right" valign="top"><a href="https://twitter.com/share" class="twitter-share-button" data-text="<?php echo $tutorial->titulo; ?> via @laspartes" data-count="vertical" data-lang="es">Tweet</a><script type="text/javascript" src="//platform.twitter.com/widgets.js"></script></td>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td colspan="2" class="general_texto_secundario" align="left" style="padding-bottom:10px;padding-top:5px;"><h3><strong>Publicado hace</strong> <strong><?php echo relative_time($tutorial->fecha); ?></strong></h3></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td colspan="2" align="left" style="padding-bottom:5px;line-height:1.5;" class="general_borde_inferior">
                                            <?php if($tutorial->imagen_url!='' && $tutorial->imagen_url!=NULL){ ?>
                                            <img class="floatLeft" src="<?php echo base_url().$tutorial->imagen_url; ?>" alt="<?php echo $tutorial->titulo; ?>" /><?php } ?>
                                            <h2 class="general_link"><strong>Resumen. </strong><?php echo $tutorial->resumen; ?></h2></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <?php $paso_actual = 1;
                                        if(sizeof($tutorial_pasos)!=0){
                                            foreach($tutorial_pasos as $tutorial_paso){ ?>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td width="861" colspan="2" align="left" style="padding-top:10px;padding-bottom:5px;line-height:1.5;" class="general_borde_inferior general_link">
                                            <?php if($tutorial_paso->imagen_url!='' && $tutorial_paso->imagen_url!=NULL){ ?><img class="floatRight" src="<?php echo base_url().$tutorial_paso->imagen_url; ?>" alt="Paso <?php echo $paso_actual; ?>" /><?php } ?>
                                            <h2 ><strong>Paso <?php echo $paso_actual; ?>. </strong><?php echo $tutorial_paso->paso; ?></h2>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <?php $paso_actual++;
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td colspan="2" align="center"><table width="860" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <?php if(!$this->session->userdata('esta_registrado')){ ?>
                                                        ...
                                                        <td width="145" align="left" valign="middle" class="general_link"><h4><a href="#registro-me-gusta" title="Registro o Inicio de Sesión" class="registro-me-gusta">Me gusta este tutorial</a></h4></td>
                                                        ...
                                                        <td width="160" class="general_link" align="left" valign="middle"><h4><a href="#registro-me-gusta" title="Registro o Inicio de Sesión" class="registro-me-gusta">No me gusta este tutorial</a></h4></td>
                                                        <td width="129" >&nbsp;</td>
                                                        <td width="324" align="right">
                                                            <h4>A <strong><?php echo $tutorial->me_gusta; ?></strong> personas les gusta este tutorial</h4>
                                                            <h4>A <strong><?php echo $tutorial->no_me_gusta; ?></strong> personas no les gusta este tutorial</h4>
                                                        </td>
                                                    <?php } else { ?>
                                                        <td class="me-gusta-decidir" <?php if($usuario_le_gusta != NULL){ ?>style="display: none"<?php } ?> width="51"><a onclick="me_gusta(<?php echo $tutorial->id_tutorial; ?>)" class="general_btn_megusta" title="Me gusta"><span>Me gusta</span></a></td>
                                                        <td class="me-gusta-decidir" <?php if($usuario_le_gusta != NULL){ ?>style="display: none"<?php } ?> width="113" align="left" valign="middle" class="general_link"><h4><a onclick="me_gusta(<?php echo $tutorial->id_tutorial; ?>)">Me gusta este tutorial</a></h4></td>
                                                        <td class="me-gusta-decidir" <?php if($usuario_le_gusta != NULL){ ?>style="display: none"<?php } ?> width="51"><a onclick="no_me_gusta(<?php echo $tutorial->id_tutorial; ?>)" class="general_btn_nomegusta" title="No me gusta"><span>No me gusta</span></a></td>
                                                        <td class="me-gusta-decidir" <?php if($usuario_le_gusta != NULL){ ?>style="display: none"<?php } ?> width="120" class="general_link" align="left" valign="middle"><h4><a onclick="no_me_gusta(<?php echo $tutorial->id_tutorial; ?>)">No me gusta este tutorial</a></h4></td>
                                                        ...
                                                        <td class="me-gusta-decision" <?php if($usuario_le_gusta==NULL || $usuario_le_gusta==0){ ?>style="display: none"<?php } ?> width="200" align="left" valign="middle" class="general_link"><h4>Me gusta este tutorial</h4></td>
                                                        ...
                                                        <td class="no-me-gusta-decision" <?php if($usuario_le_gusta==NULL || $usuario_le_gusta==1){ ?>style="display: none"<?php } ?> width="200" align="left" valign="middle" class="general_link"><h4>No me gusta esta tutorial</h4></td>
                                                        ...
                                                        <td width="129" >&nbsp;</td>
                                                        <td width="324" align="right">
                                                            <h4>A <strong id="me-gusta-cantidad"><?php echo $tutorial->me_gusta; ?></strong> personas les gusta este tutorial</h4>
                                                            <h4>A <strong id="no-me-gusta-cantidad"><?php echo $tutorial->no_me_gusta; ?></strong> personas no les gusta este tutorial</h4>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td colspan="2" align="right" class="general_link" style="padding-bottom:10px;"><h4><a id="link-reportar-abuso-<?php $tutorial->id_tutorial; ?>" class="link-reportar-abuso" href="<?php echo base_url().'usuario/formulario_reportar_abuso_ajax/aprende/tutorial/'.$tutorial->id_tutorial; ?>">Reportar abuso</a></h4></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td colspan="2" align="left" class="general_link" style="padding-left:10px;padding-bottom:10px;"><h4>¿Quiere proponer el tema del próximo tutorial? <span style="font-size:14px;"><a href="#publicar-tutorial" id="publicar-tutorial-link">Haga click aquí</a></span></h4></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                </table>
                            </td>
            ...
            <tr>
                ...
                <td width="554" valign="top" class="box_fondo">
                    <table width="554" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="box_borde_izq">&nbsp;</td>
                            <td colspan="2" class="box_fondo_contenido"><table width="526" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td colspan="6" class="general_separador_transparente"></td>
                                    </tr>
                                    <?php $config = array('id' => 'formulario_agregar_comentario');
                                        echo form_open('aprende/agregar_tutorial_comentario', $config); ?>
                                    ...
                                    <tr id="comentario-<?php echo $comentario->id_tutorial_comentario; ?>">
                                        <td width="15">&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td width="161">&nbsp;</td>
                                        <td colspan="2" align="right" class="general_link" style="padding:5px;"><h4><a id="link-reportar-abuso-<?php $comentario->id_tutorial_comentario; ?>" class="link-reportar-abuso" href="<?php echo base_url().'usuario/formulario_reportar_abuso_ajax/aprende/tutorial/'.$comentario->id_tutorial_comentario; ?>">Reportar abuso</a></h4></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td></td>
                ...
                <td width="376" valign="top" class="box_fondo">
                    <table width="376" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td width="141" height="22" class="box_fondo box_titulo"><h1>MÁS TUTORIALES</h1></td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="box_fondo_contenido"><table width="346" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <?php if(sizeof($tutoriales)!=0){
                                        foreach($tutoriales as $otro_tutorial){ 
                                           if($otro_tutorial->id_tutorial != $tutorial->id_tutorial ){ ?>
                                    <tr>
                                        <td class="general_link " align="left">&nbsp;</td>
                                        <td class="general_link " align="left"><h2><a href="<?php echo base_url(); ?>aprende/tutorial/<?php echo $otro_tutorial->id_tutorial; ?>/<?php echo str_replace(' ', '-', convert_accented_characters($otro_tutorial->titulo)); ?>"><?php echo $otro_tutorial->titulo; ?></a></h2></td>
                                        <td class="general_link " align="left">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="left" class=" general_texto_secundario">&nbsp;</td>
                                        <td align="right" class=" general_texto_secundario"><h4><strong>Publicado hace <?php echo relative_time($otro_tutorial->fecha); ?></strong></h4></td>
                                        <td align="left" class=" general_texto_secundario">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="" align="right">&nbsp;</td>
                                        <td class="" align="right" style="padding-bottom:10px;"><h4><img src="<?php echo base_url(); ?>resources/images/iconos/megusta.gif" width="20" height="20" alt="Me gusta" /> A <strong><?php echo $otro_tutorial->me_gusta; ?></strong> personas les gusta</h4></td>
                                        <td class="" align="right">&nbsp;</td>
                                    </tr>
                                    <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="box_fondo_contenido">
                                    ...
                                    echo form_open('aprende/agregar_tutorial_comentario_registrarse', $config); ?>
                                    <input type="hidden" name="id_tutorial_registrarse" id="id_tutorial_registrarse" value="<?php echo $tutorial->id_tutorial; ?>" />
...
?>
                    ...
                    <td width="373" valign="top" class="box_fondo">
                        ...
                        echo form_open('aprende/agregar_tutorial_comentario_ingresar', $config); ?>
                        <input type="hidden" name="id_tutorial_ingresar" id="id_tutorial_ingresar" value="<?php echo $tutorial->id_tutorial; ?>" />
...
<tr style="display: none;">
    <td>
        <div id="publicar-tutorial" align="center">
                ...
                <tr>
                    <td valign="top" class="box_fondo" align="center">
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td class="box_borde_izq">&nbsp;</td>
                                <td class="box_fondo_contenido" align="left" style="padding:10px;"><h2>Cuéntenos qué le gustaría aprender en el próximo tutorial "hágalo usted mismo". Su dirección electrónica (e-mail) la necesitamos para darle el reconocimiento respectivo en el caso de publicar un tutorial o en caso de necesitar información adicional.</h2></td>
                    ...
                    <td valign="top" class="box_fondo">
                        <table width="600" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td width="287" class="box_fondo"></td>
                                <td width="285" class="box_borde_sup" ></td>
                                <td height="14" class="box_esquina_sup_der" width="14"></td>
                            </tr>
                            <tr>
                                <td height="22" class="box_fondo box_titulo"><h1>HÁGALO USTED MISMO - NUEVO TUTORIAL</h1></td>
                                <td class="box_fondo_contenido box_ordenamiento">&nbsp;</td>
                                <td class="box_borde_der">&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="box_fondo_contenido">
                                    <table width="571" border="0" cellspacing="0" cellpadding="0">
                                        <?php $config = array('id' => 'formulario_publicar_tutorial');
                                        echo form_open('aprende/publicar_tutorial', $config); ?>
                                        <input type="hidden" name="id_tutorial_publicar_tutorial" value="<?php echo $tutorial->id_tutorial; ?>" />
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align="left" valign="middle" class="general_formulario_texto" style="padding-bottom:1px;padding-left:15px;padding-right:15px;">
                                                <input class="general_cuadro_texto" type="text" name="email_publicar_tutorial" id="email_publicar_tutorial" size="67" />
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="2" class="general_formulario_texto" style="padding-left:15px;padding-top:10px;"><h2>Qué le gustaría ver en el próximo tutorial: </h2></td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="2" class="general_formulario_texto" style="padding-bottom:15px;padding-left:15px;padding-right:15px;">
                                                ...
                                                <textarea class="general_textarea" name="tutorial_publicar_tutorial" id="tutorial_publicar_tutorial" rows="8" cols="50"></textarea>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
