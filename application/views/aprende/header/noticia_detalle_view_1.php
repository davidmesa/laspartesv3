<meta property="og:image" content="<?php if($noticia->imagen_url!='') echo base_url().$noticia->imagen_url; else echo base_url().'resources/images/template/logos/laspartes160x97.gif'; ?>">

<link rel="image_src" href="<?php if($noticia->imagen_url!='') echo base_url().$noticia->imagen_url; else echo base_url().'resources/images/template/logos/laspartes160x97.gif'; ?>">
...
<?php } ?>
                ...
                $("#publicar-noticia-link").fancybox({
                    'transitionIn': 'none',
                    'transitionOut': 'none'
                });
                ...
                $("#formulario_publicar_noticia").validate({
                    rules: {
                        email_publicar_noticia: {
                            email: true,
                            required: true
                        },
                        noticia_publicar_noticia: {
                            required: true
                        }
                    },
                    messages: {
            ...
            function me_gusta(id_noticia_p){
                $(".me-gusta-decidir").hide();
                $("#me-gusta-cantidad").text(parseInt($("#me-gusta-cantidad").text())+1);
                $(".me-gusta-decision").show();
                $.ajax({
                    url: "<?php echo base_url(); ?>aprende/agregar_noticia_me_gusta_ajax/",
                    type: "POST",
                    data: {
                        id_noticia: id_noticia_p,
                        me_gusta: 1
                    },
                    onsubmit: false
                });
            ...
            function no_me_gusta(id_noticia_p){
                $(".me-gusta-decidir").hide();
