<meta property="og:image" content="<?php if($tip->imagen_url!='') echo base_url().$tip->imagen_url; else echo base_url().'resources/images/template/logos/laspartes160x97.gif'; ?>">

<link rel="image_src" href="<?php if($tip->imagen_url!='') echo base_url().$tip->imagen_url; else echo base_url().'resources/images/template/logos/laspartes160x97.gif'; ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#formulario_publicar_tip").validate({
            rules: {
                email_publicar_tip: {
                    email: true,
                    required: true
