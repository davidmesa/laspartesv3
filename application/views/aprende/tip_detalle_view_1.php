            ...
            <tr>
                ...
                <td colspan="2" valign="top" class="box_fondo">
                    <table width="930" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td width="158" height="22" class="box_fondo box_titulo"><h1>TIPS Y CONSEJOS</h1></td>
                            <td width="744" class="box_fondo_contenido">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="box_fondo_contenido">
                                <table width="901" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="20">&nbsp;</td>
                                        <td  class="tallerenlinea_texto_pregunta" align="left" style="padding-top:10px;"><strong><?php echo $tip->titulo; ?></strong></td>
                                        <td align="right">
                                            <table width="200">
                                                <tr>
                                                    ...
                                                    <td align="right" valign="top"><a href="https://twitter.com/share" class="twitter-share-button" data-text="<?php echo $tip->titulo; ?> via @laspartes" data-count="vertical" data-lang="es">Tweet</a><script type="text/javascript" src="//platform.twitter.com/widgets.js"></script></td>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td colspan="2" class="general_texto_secundario" align="left" style="padding-bottom:10px;padding-top:5px;"><h3><strong>Publicado hace</strong> <strong><?php echo relative_time($tip->fecha); ?></strong></h3></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td colspan="2" width="861" valign="top" align="left" style="padding-top:5px;padding-bottom:5px;line-height:1.5;">
                                            <h2 class="general_link">
                                                <img src="<?php if($tip->imagen_url!='' && $tip->imagen_url!=NULL){ echo base_url().$tip->imagen_url; } else { echo base_url().'resources/images/micuenta/tmpl_img_micuenta_vehiculo_nd.gif'; }?>" width="150" height="150" alt="<?php echo $tip->titulo; ?>" class="floatLeft" />
                                                <?php echo $tip->tip; ?><br />
                                            </h2></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                            ...
                                            <table width="860" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <?php if(!$this->session->userdata('esta_registrado')){ ?>
                                                        ...
                                                        <td width="145" align="left" valign="middle" class="general_link"><h4><a href="#registro-me-gusta" title="Registro o Inicio de Sesión" class="registro-me-gusta">Me gusta este consejo</a></h4></td>
                                                        ...
                                                        <td width="160" class="general_link" align="left" valign="middle"><h4><a href="#registro-me-gusta" title="Registro o Inicio de Sesión" class="registro-me-gusta">No me gusta este consejo</a></h4></td>
                                                        <td width="129" >&nbsp;</td>
                                                        <td width="324" align="right">
                                                            <h4>A <strong><?php echo $tip->me_gusta; ?></strong> personas les gusta este consejo</h4>
                                                            <h4>A <strong><?php echo $tip->no_me_gusta; ?></strong> personas no les gusta este consejo</h4>
                                                        </td>
                                                    <?php } else { ?>
                                                        <td class="me-gusta-decidir" <?php if($usuario_le_gusta != NULL){ ?>style="display: none"<?php } ?> width="51"><a onclick="me_gusta(<?php echo $tip->id_tip; ?>)" class="general_btn_megusta" title="Me gusta"><span>Me gusta</span></a></td>
                                                        <td class="me-gusta-decidir" <?php if($usuario_le_gusta != NULL){ ?>style="display: none"<?php } ?> width="113" align="left" valign="middle" class="general_link"><h4><a onclick="me_gusta(<?php echo $tip->id_tip; ?>)">Me gusta este consejo</a></h4></td>
                                                        <td class="me-gusta-decidir" <?php if($usuario_le_gusta != NULL){ ?>style="display: none"<?php } ?> width="51"><a onclick="no_me_gusta(<?php echo $tip->id_tip; ?>)" class="general_btn_nomegusta" title="No me gusta"><span>No me gusta</span></a></td>
                                                        <td class="me-gusta-decidir" <?php if($usuario_le_gusta != NULL){ ?>style="display: none"<?php } ?> width="120" class="general_link" align="left" valign="middle"><h4><a onclick="no_me_gusta(<?php echo $tip->id_tip; ?>)">No me gusta este consejo</a></h4></td>
                                                        ...
                                                        <td class="me-gusta-decision" <?php if($usuario_le_gusta==NULL || $usuario_le_gusta==0){ ?>style="display: none"<?php } ?> width="200" align="left" valign="middle" class="general_link"><h4>Me gusta este consejo</h4></td>
                                                        ...
                                                        <td class="no-me-gusta-decision" <?php if($usuario_le_gusta==NULL || $usuario_le_gusta==1){ ?>style="display: none"<?php } ?> width="200" align="left" valign="middle" class="general_link"><h4>No me gusta este consejo</h4></td>
                                                        ...
                                                        <td width="129" >&nbsp;</td>
                                                        <td width="324" align="right">
                                                            <h4>A <strong id="me-gusta-cantidad"><?php echo $tip->me_gusta; ?></strong> personas les gusta este consejo</h4>
                                                            <h4>A <strong id="no-me-gusta-cantidad"><?php echo $tip->no_me_gusta; ?></strong> personas no les gusta este consejo</h4>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td colspan="2" align="right" class="general_link" style="padding-bottom:10px;"><h4><a id="link-reportar-abuso-<?php $tip->id_tip; ?>" class="link-reportar-abuso" href="<?php echo base_url().'usuario/formulario_reportar_abuso_ajax/aprende/tip/'.$tip->id_tip; ?>">Reportar abuso</a></h4></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td colspan="2" align="left" class="general_link" style="padding-left:10px;padding-bottom:10px;"><h4>¿Le gustaría publicar un tip o consejo en nuestra comunidad? <span style="font-size:14px;"><a href="#publicar-tip" id="publicar-tip-link">Haga click aquí</a></span></h4></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                </table>
                            </td>
            ...
            <tr>
                            ...
                            <td colspan="2" class="box_fondo_contenido">
                                <table width="526" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <?php $config = array('id' => 'formulario_agregar_comentario');
                                        echo form_open('aprende/agregar_tip_comentario', $config); ?>
                                    ...
                                    <tr id="comentario-<?php echo $comentario->id_tip_comentario; ?>">
                                        <td width="15">&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td width="161">&nbsp;</td>
                                        <td colspan="2" align="right" class="general_link" style="padding:5px;"><h4><a id="link-reportar-abuso-<?php $comentario->id_tip_comentario; ?>" class="link-reportar-abuso" href="<?php echo base_url().'usuario/formulario_reportar_abuso_ajax/aprende/tip/'.$comentario->id_tip_comentario; ?>">Reportar abuso</a></h4></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td></td>
                ...
                <td width="376" valign="top" class="box_fondo">
                    <table width="376" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td width="213" height="22" class="box_fondo box_titulo"><h1>MÁS TIPS Y CONSEJOS</h1></td>
                            <td width="135" class="box_fondo_contenido">&nbsp;</td>
                            <td width="14" rowspan="2" class="box_borde_der">&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="box_borde_izq">&nbsp;</td>
                            <td colspan="2" class="box_fondo_contenido"><table width="346" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="general_link " align="left"><h2><a href="<?php echo base_url(); ?>aprende/tip/<?php echo $otro_tip->id_tip; ?>/<?php echo str_replace(' ', '-', convert_accented_characters($otro_tip->titulo)); ?>"><?php echo $otro_tip->titulo; ?></a></h2></td>
                                        <td class="general_link " align="left">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="left" class=" general_texto_secundario">&nbsp;</td>
                                        <td align="right" class=" general_texto_secundario"><h4><strong>Publicado hace <?php echo relative_time($otro_tip->fecha); ?></strong></h4></td>
                                        <td align="left" class=" general_texto_secundario">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="" align="right">&nbsp;</td>
                                        <td class="" align="right" style="padding-bottom:10px;"><h4><img src="<?php echo base_url(); ?>resources/images/iconos/megusta.gif" width="20" height="20" alt="Me gusta" /> A <strong><?php echo $otro_tip->me_gusta; ?></strong> personas les gusta</h4></td>
                                        <td class="" align="right">&nbsp;</td>
                                    </tr>
                                    <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="box_fondo_contenido">
                                    ...
                                    echo form_open('aprende/agregar_tip_comentario_registrarse', $config); ?>
                                    <input type="hidden" name="id_tip_registrarse" id="id_tip_registrarse" value="<?php echo $tip->id_tip; ?>" />
...
?>
                    ...
                    <td width="373" valign="top" class="box_fondo">
                        ...
                        echo form_open('aprende/agregar_tip_comentario_ingresar', $config); ?>
                        <input type="hidden" name="id_tip_ingresar" id="id_tip_ingresar" value="<?php echo $tip->id_tip; ?>" />
...
<tr style="display: none;">
    <td>
        <div id="publicar-tip" align="center">
                ...
                <tr>
                    <td valign="top" class="box_fondo" align="center">
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td class="box_borde_izq">&nbsp;</td>
                                <td class="box_fondo_contenido" align="left" style="padding:10px;"><h2>Cuéntenos el tip o consejo que le gustaría que sea publicado. En el caso de ser publicado, su nombre de usuario aparecerá como autor del tip o consejo.</h2></td>
                    ...
                    <td valign="top" class="box_fondo">
                        <table width="600" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td width="189" class="box_fondo"></td>
                                <td width="383" class="box_borde_sup" ></td>
                                <td height="14" class="box_esquina_sup_der" width="14"></td>
                            </tr>
                            <tr>
                                <td height="22" class="box_fondo box_titulo"><h1>PUBLICAR TIP O CONSEJO</h1></td>
                                <td class="box_fondo_contenido box_ordenamiento">&nbsp;</td>
                                <td class="box_borde_der">&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="box_fondo_contenido">
                                    <table width="571" border="0" cellspacing="0" cellpadding="0">
                                        <?php $config = array('id' => 'formulario_publicar_tip');
                                        echo form_open('aprende/publicar_tip', $config); ?>
                                        <input type="hidden" name="id_tip_publicar_tip" value="<?php echo $tip->id_tip; ?>" />
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align="left" valign="middle" class="general_formulario_texto" style="padding-bottom:1px;padding-left:15px;padding-right:15px;">
                                                <input class="general_cuadro_texto" type="text" name="email_publicar_tip" id="email_publicar_tip" size="67" />
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="2" class="general_formulario_texto" style="padding-left:15px;padding-top:10px;"><h2>Tip o consejo: (600 caracteres faltantes)</h2></td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="2" class="general_formulario_texto" style="padding-bottom:15px;padding-left:15px;padding-right:15px;">
                                                ...
                                                <textarea class="general_textarea" name="tip_publicar_tip" id="tip_publicar_tip" rows="8" cols="50"></textarea>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
