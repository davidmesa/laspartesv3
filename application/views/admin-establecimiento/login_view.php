...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>resources/admin-establecimiento/js/jquery.validate.js" ></script>

        <link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>resources/admin-establecimiento/css/styles.css" />
        <link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>resources/admin-establecimiento/css/login.css" />
    </head>
    ...
    <body>
        <div id="admin_wrapper">
            ...
            <?php echo form_open('admin-establecimiento/inicio/validar_usuario'); ?>
                <div id="logo">
