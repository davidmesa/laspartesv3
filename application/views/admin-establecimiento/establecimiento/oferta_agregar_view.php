...
<!--        <script type="text/javascript" src="<?php echo base_url(); ?>resources/admin/js/jquery1.4.3.js"></script>-->
 ...
 echo form_open("admin-establecimiento/establecimiento/agregar_oferta/".$id_establecimiento, $attributes); ?>
                ...
                ?>
                    ...
                    <p>
                      ...
                      <input name="titulo" type="text" class="text medium" />
                    </p><br/>
                    <p>
                      <label>Precio</label><br />
                      <input name="precio" type="text" class="text medium" />
                    </p><br/>
                    
                    <p>
                      <label>IVA</label><br />
                      <input name="iva" type="text" class="text medium" />
                    </p><br/>
                     <p>
                      <label>Descripcion</label>
                       <?php echo $this->ckeditor->editor("descripcion", "descripcion..", $config_mini);?>
                    </p><br/>
                    ...
                    <div>
                        ...
                        <input name="vigencia" id="Range" type="textbox" value="<?php echo mdate("%Y-%m-%d"); ?>"/>
                        <div id="fromCalendar"></div>
                    </div>    

                <p>
                    <h2>Servicios asociados</h2>
                    <p>*Seleccione al menos una de las categorías de servicios.</p>
                </p>
                <table width="100%">
                 <tr>
