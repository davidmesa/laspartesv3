    ...
    <body>
        ...
        <div id="main_content_wrap" class="container_12">
            <div class="container_12">
                ...
                <h4>Escoge un establecimiento para visualizar las ventas que haz realizado.</h4>
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td><a href="<?php echo base_url(); ?>admin-establecimiento/ventas/ver_ventas/<?php echo $establecimiento->id_establecimiento; ?>"><?php echo $establecimiento->id_establecimiento; ?></a></td>
                        ...
                        <td><a href="<?php echo base_url(); ?>admin-establecimiento/ventas/ver_ventas/<?php echo $establecimiento->id_establecimiento; ?>"><img src="<?php echo base_url(); ?>resources/admin-establecimiento/images/pencil.png" alt="Ver o Actualizar mis ventas" /></a></td>
                    </tr>
                    <?php }
                    }?>
                </table>
