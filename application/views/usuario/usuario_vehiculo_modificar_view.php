            ...
            <tr>
                ...
                <td width="605" valign="top" class="box_fondo">
                    <table width="605" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td height="22" class="box_fondo box_titulo"><h1>EDITAR VEH&Iacute;CULO</h1></td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="box_fondo_contenido">
                                <?php $config = array('id' => 'formulario_modificar_vehiculo');
                                    echo form_open_multipart('usuario/modificar_vehiculo', $config); ?>
                                <input type="hidden" name="id_usuario_vehiculo" value="<?php echo $vehiculo->id_usuario_vehiculo; ?>" />
                                <input type="hidden" name="kilometraje" id="kilometraje" value="<?php echo $vehiculo->kilometraje; ?>" />
                                <table width="575" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <table width="532" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="110" rowspan="4" valign="bottom" align="center"><img src="<?php if($vehiculo->imagen_thumb_url!=NULL || $vehiculo->imagen_thumb_url!=''){ echo base_url().$vehiculo->imagen_thumb_url; } else { echo base_url().'resources/images/micuenta/tmpl_img_micuenta_vehiculo_nd.gif'; } ?>" width="99" height="99" alt="Foto vehiculo" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="general_formulario_texto" style="padding-bottom:5px;padding-left:5px;" align="left">
                                            <input class="general_cuadro_texto" type="text" name="modelo" id="modelo" size="34" value="<?php echo $vehiculo->modelo; ?>"/>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
...
$selected = $vehiculo->kilometraje<0?-1:5000*floor($vehiculo->kilometraje/5000);
$option_kilometraje['-1'] = 'No reconozco';
for($i = 1; $i < 100000; $i += 5000){
	$option_kilometraje[$i-1] = $i.' Km. - '.($i + 4999).' Km.';
}
echo form_dropdown('kilometraje_opt', $option_kilometraje, $selected, 'onchange="seleccionarKilometraje(this)"');
?></h2>
<script>
function seleccionarKilometraje(selection){
	var kil = $(selection).val();
	$('#kilometraje').val(kil);
}
</script>
</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="general_formulario_texto" style="padding-bottom:5px;padding-left:5px;" align="left">
                                            <input class="general_cuadro_texto" type="text" name="placa" id="placa" size="34" value="<?php echo $vehiculo->numero_placa; ?>"/>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
